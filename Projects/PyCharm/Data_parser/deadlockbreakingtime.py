...
def parse(filename):
    ...
    with open("DEADLOCKBREAKING_OUTPUT.txt", 'w') as outputfile:
        with open(filename, 'r') as inputfile:
            ...
            cntr = 0
            data_list = []
            print "Deadlock-breaking time" + os.linesep + "Input file: " + filename + os.linesep + "Output file: DEADLOCKBREAKING_OUTPUT.txt"
            line = 0
