...
def parse(filename):
    ...
    with open("LATENCYANDJITTER_OUTPUT.txt", 'w') as outputfile:
        with open(filename, 'r') as inputfile:
            ...
            cntr = 0
            data_list = []
            print "Latency and Jitter" + os.linesep + "Input file: " + filename + os.linesep + "Output file: LATENCYANDJITTER_OUTPUT.txt"
            line = 0
