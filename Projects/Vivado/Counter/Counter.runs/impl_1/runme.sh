...
HD_PWD='D:/My Tresors/Diplomaterv/Github/Projects/Vivado/Counter/Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_Counter_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basys3_Counter_Top.tcl -notrace
