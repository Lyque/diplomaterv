...
HD_PWD='D:/My Tresors/Diplomaterv/Github/Projects/Vivado/Counter/Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_Counter_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys3_Counter_Top.tcl
