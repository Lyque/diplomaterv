...
A mérések feldolgozását \emph{Python} szkripttel végeztem el. Két szkript megírása vált szükségessé. Az egyik szkript a mérés során keletkezett száz fájlból készített egy darab fájlt, míg a másik szkript végezte a meghatározandó adatok kinyerését az egyesített fájlból.
