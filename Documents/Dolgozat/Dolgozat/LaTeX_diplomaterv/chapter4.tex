...
Emellett tüskesorokat alkalmaztam a mérési pontok kivezetésére (IN, OUT és ID lábak\footnote{Az ID lábakok az éppen futó taszk 4~bites azonosítója mérhetõ.}), illetve az SD kártya foglalat csatlakoztatása is tüskesoron keresztül történhet. A BLE112 modul lábainak többsége szintén kivezetésre került, ezáltal a modul képességeinek tesztelésekhez is használható a kártya.
...
\caption{Basys~3 fejlesztõkártya.}
\label{fig:Basys3}
\end{figure}
