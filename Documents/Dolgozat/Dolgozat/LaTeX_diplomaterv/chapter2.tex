...
Az STM32F4 Discovery kártyához elérhetõ szoftvercsomag tartalmazza a \mbox{FreeRTOS} rendszert, ami jelzi a rendszer támogatottságának mértékét. A \mbox{FreeRTOS} hivatalos oldalán megvásárolhatóak a rendszer használatát bemutató könyvek, illetve online elérhetõ leírások, amik szintén segítik a rendszer megismerését. Ezáltal az elsõ megvizsgált rendszernek a \mbox{FreeRTOS}-t választottam.

A Micrium uC/OS rendszerei oktatási célra ingyenesen elérhetõek, beleértve a rendszer dokumentációit is. A választott másik rendszer a \mbox{uC/OS-III}.
